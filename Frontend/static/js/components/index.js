...
function toggleSound(){
    var state = localStorage.getItem("voice");
    if(state == "on" || state == undefined){
        var icon = document.getElementById("sound-mute");
        icon.setAttribute("src", "./static/img/mute.svg");
        localStorage.setItem("voice","off");
    }
    else{
        var icon = document.getElementById("sound-mute");
        icon.setAttribute("src", "./static/img/sound.svg");
